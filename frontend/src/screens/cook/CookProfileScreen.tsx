  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.header}>
        ...
        <Text style={styles.kitchen}>{user?.kitchenName || 'My Kitchen'}</Text>
        <View style={styles.roleBadge}>
          <Text style={styles.roleText}>Home Cook</Text>
        </View>
      </View>
        ...
        {user?.specialties && user.specialties.length > 0 && (
          <>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoText}>{user.specialties.join(', ')}</Text>
            </View>
          </>
        )}
      </Card>
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: Colors.secondary, paddingTop: 60, paddingBottom: 30, alignItems: 'center', borderBottomLeftRadius: 30, borderBottomRightRadius: 30 },
  ...
  kitchen: { fontSize: Fonts.sizes.md, color: 'rgba(255,255,255,0.8)', marginTop: 2 },
  ...
  menuIcon: { width: 36, height: 36, borderRadius: 10, backgroundColor: '#FFF7ED', justifyContent: 'center', alignItems: 'center', marginRight: 14 },
